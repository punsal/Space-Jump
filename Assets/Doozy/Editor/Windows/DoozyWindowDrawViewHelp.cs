    ...
    public partial class DoozyWindow
    {
        ...
        private void DrawViewHelp()
        {
            ...
            GUILayout.BeginHorizontal(GUILayout.ExpandWidth(true));
            {
                ...
                GUILayout.BeginVertical(GUILayout.ExpandWidth(true), GUILayout.MaxWidth(GeneralColumnWidth));
                {
                    ...
                    DrawDynamicViewVerticalSpace(0.25f);
                    DrawHelpLinkBox("FAQ", "Frequently Asked Questions", Styles.GetStyle(Styles.StyleName.IconFaQuestion), DGUI.Colors.LightOrDarkColorName, UILabels.Open, DoozySettings.LINK_WEBSITE_DOOZYUI_FAQ);
                    DrawDynamicViewVerticalSpace(0.25f);
        ...
        private static void DrawHelpLinkBoxSupportEmail()
        {
            string emailLink = DoozySettings.MAILTO +
                               ...
                               "?subject=DoozyUI - Support Request" +
                               "&body=" +
                               "What Happened" +
                               "%0D%0A" +
                               "------------------" +
            ...
            DrawHelpLinkBox(UILabels.SupportEmail, DoozySettings.SUPPORT_EMAIL_ADDRESS, Styles.GetStyle(Styles.StyleName.IconFaEnvelope), DGUI.Colors.LightOrDarkColorName, UILabels.Send, emailLink);
        }
