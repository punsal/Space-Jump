...
#pragma warning restore 0649
        ...
        /// <summary> Activates the passed Node if it belongs to the Graph </summary>
        ...
        /// <summary> Activates the first Node, found inside the Graph, with the given node name (if it exists) </summary>
        ...
        /// <summary> Activates the Node, found inside the Graph, with the given node id (if it exists) </summary>
