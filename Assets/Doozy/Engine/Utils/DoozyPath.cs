...
namespace Doozy.Engine.Utils
{
    ...
    public class DoozyPath : ScriptableObject
    {
        ...
        public static void CreateMissingFolders()
        {
            ...
            DoozyUtils.DisplayProgressBar("Hold On", "Creating Folders...", 0.1f);
            ...
            DoozyUtils.DisplayProgressBar("Hold On", "Creating Folders...", 0.11f);
            ...
            DoozyUtils.DisplayProgressBar("Hold On", "Creating Folders...", 0.12f);
            ...
            DoozyUtils.DisplayProgressBar("Hold On", "Creating Folders...", 0.13f);
            ...
            DoozyUtils.DisplayProgressBar("Hold On", "Creating Folders...", 0.14f);
            ...
            DoozyUtils.DisplayProgressBar("Hold On", "Creating Folders...", 0.15f);
            ...
            DoozyUtils.DisplayProgressBar("Hold On", "Creating Folders...", 0.16f);
            ...
            DoozyUtils.DisplayProgressBar("Hold On", "Creating Folders...", 0.17f);
            ...
            DoozyUtils.DisplayProgressBar("Hold On", "Creating Folders...", 0.2f);
            ...
            DoozyUtils.DisplayProgressBar("Hold On", "Creating Folders...", 0.25f);
            ...
            DoozyUtils.DisplayProgressBar("Hold On", "Creating Folders...", 0.3f);
            ...
            DoozyUtils.DisplayProgressBar("Hold On", "Creating Folders...", 0.4f);
            ...
            DoozyUtils.DisplayProgressBar("Hold On", "Creating Folders...", 0.5f);
            ...
            DoozyUtils.DisplayProgressBar("Hold On", "Creating Folders...", 0.51f);
            ...
            DoozyUtils.DisplayProgressBar("Hold On", "Creating Folders...", 0.52f);
            ...
            DoozyUtils.DisplayProgressBar("Hold On", "Creating Folders...", 0.53f);
            ...
            DoozyUtils.DisplayProgressBar("Hold On", "Creating Folders...", 0.54f);
            ...
            DoozyUtils.DisplayProgressBar("Hold On", "Creating Folders...", 0.55f);
            ...
            DoozyUtils.DisplayProgressBar("Hold On", "Creating Folders...", 0.61f);
            ...
            DoozyUtils.DisplayProgressBar("Hold On", "Creating Folders...", 0.62f);
            ...
            DoozyUtils.DisplayProgressBar("Hold On", "Creating Folders...", 0.63f);
            ...
            DoozyUtils.DisplayProgressBar("Hold On", "Creating Folders...", 0.64f);
            ...
            DoozyUtils.DisplayProgressBar("Hold On", "Creating Folders...", 0.65f);
            ...
            DoozyUtils.DisplayProgressBar("Hold On", "Creating Folders...", 0.66f);
