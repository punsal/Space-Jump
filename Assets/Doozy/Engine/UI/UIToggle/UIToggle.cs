    ...
    public class UIToggle : UIComponentBase<UIToggle>, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler, ISelectHandler, IDeselectHandler
    {
        ...
        public bool IsSelected
        {
            get
            {
                ...
                if (current == null) new GameObject("EventSystem", typeof(EventSystem), typeof(StandaloneInputModule));

                return current != null && current.currentSelectedGameObject == gameObject;
            }
        }
        ...
        /// <summary> Deselects this toggle from the EventSystem (if selected) </summary>
        ...
        // ReSharper disable once UnusedMember.Global
        /// <summary> Deselects this toggle from the EventSystem (if selected), after a set delay </summary>
        ...
        /// <summary> Sets Interactable to FALSE </summary>
        public void DisableToggle() { Interactable = false; }

        /// <summary> Disables the toggle for a set time duration </summary>
        ...
        /// <summary> Executes OnPointerEnter actions, if enabled </summary>
        ...
        /// <summary> Executes OnPointerExit actions, if enabled </summary>
        /// <param name="debug"> Enables relevant debug messages to be printed to the console </param>
        ...
        /// <summary> Executes OnClick actions, if enabled </summary>
        /// <param name="debug"> Enables relevant debug messages to be printed to the console </param>
        ...
        /// <summary> Executes OnDeselected actions, if enabled </summary>
        /// <param name="debug"> Enables relevant debug messages to be printed to the console </param>
        ...
        /// <summary> Executes OnSelected actions, if enabled </summary>
        /// <param name="debug"> Enables relevant debug messages to be printed to the console </param>
        ...
        /// <summary> Loads all the preset animations, that are set to be loaded at runtime, for all the enabled behaviors </summary>
        ...
        /// <summary> Sends an UIToggleMessage notifying the system that an UIToggleBehavior has been triggered </summary>
        ...
        /// <summary> Selects this toggle in the EventSystem </summary>
        public void SelectToggle() { EventSystem.current.SetSelectedGameObject(gameObject); }
        ...
        /// <summary> Toggles the toggle off. IsOn = false </summary>
        public void ToggleOff() { IsOn = false; }

        /// <summary> Toggles the toggle on. IsOn = true </summary>
