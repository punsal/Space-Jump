...
namespace Doozy.Engine.UI
{
    ...
    public class UIButton : UIComponentBase<UIButton>, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler, IPointerUpHandler, IPointerClickHandler, ISelectHandler, IDeselectHandler
    {
        ...
        /// <summary> Deselects this button from the EventSystem (if selected) </summary>
        ...
        /// <summary> Deselects this button from the EventSystem (if selected), after a set delay </summary>
        ...
        /// <summary> Disables the button for a set time duration </summary>
        ...
        /// <summary> Executes OnPointerDown actions, if enabled </summary>
        /// <param name="debug"> Enables relevant debug messages to be printed to the console </param>
        ...
        /// <summary> Executes OnPointerUp actions, if enabled </summary>
        /// <param name="debug"> Enables relevant debug messages to be printed to the console </param>
        ...
        /// <summary> Executes OnDoubleClick actions, if enabled </summary>
        /// <param name="debug"> Enables relevant debug messages to be printed to the console </param>
        ...
        /// <summary> Executes OnLongClick actions, if enabled </summary>
        /// <param name="debug"> Enables relevant debug messages to be printed to the console </param>
        ...
        public void SelectButton() { EventSystem.current.SetSelectedGameObject(gameObject); }
